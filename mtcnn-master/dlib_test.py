...
image_name = "./image/zoom4.png"
resultImg_name = "./result/dlib.jpg"

# 얼굴
img = cv2.imread(image_name)  # 이미지 파일 불러오기
dets = detector(img, 1)
...
cv2.namedWindow('img')
cv2.imshow('img', img)
cv2.imwrite(resultImg_name, cv2.cvtColor(img, cv2.COLOR_RGB2BGR))
